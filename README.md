...
- Optional HTML (open locally): [system architecture](docs/architecture-overview.html), [showcase landing](docs/system-showcase.html), [presentation slide](docs/presentation.html)
